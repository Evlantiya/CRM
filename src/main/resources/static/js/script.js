$(function(){
	...
	$("a#contacts").click(displayClientsList);
...
function displayClientsList(){
	...
	$.ajax({
		...
		success: function(data) {
			...
			container.append("<h3>Clients</h3>");

			container.append("<h4><a class='add-contact' href='#'>Add client</a></h4>");
...
function displayOrganizationEdit(clickedElement){
	...
	$.ajax({
		...
		success: function(organization) {
			...
			container.append("<a href='#' class='show-contacts' data-id='"+organization.id+"'> Show clients from this organization </a>");
...
function displayOrganizationContacts(clickedElement){
	...
	$.ajax({
		url: "/resources/clients?organizationId=" + dataId,
		type: "GET",
		contentType: "application/json; charset=utf-8",
		success: function(data) {
			...
			$("contacts", container).append("<h4>Clients from this organization:</h4>");
...
function contactEditFormSubmit(event){
	...
	$.ajax({
		url: "/resources/clients/" + contact.id,
		type: "PUT",
		data: JSON.stringify(contact),
		contentType: "application/json; charset=utf-8",
		dataType: "json",
